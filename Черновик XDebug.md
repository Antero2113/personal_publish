...
XDebug — расширение PHP, упрощающее отладку кода. Позволяет устанавливать брейкпоинты, останавливая исполнение, просматривать текущие значения переменных окружения, определённых в коде переменных и стандартных переменных PHP.
